...
const ContactUsPage = () => {
  const [state, handleSubmit] = useForm("mdkzpvgg"); // Formspree form ID
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-200 to-blue-150 py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">Kollam, Kerala, India</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:scanserviceandhelp@gmail.com" className="text-blue-600 hover:underline">
                        scanserviceandhelp@gmail.com
                      </a>
                    </div>
                  </div>
                </div>
